...
/*****PLR2 ADDED BY KIZEREN 2003 *****/


/**********************************************************************************
 *This is for the new player 2 flags.  The player 1 flags are all used up.
 **********************************************************************************/
...
const struct flag_type comm_flags[] =
{
    ...
    {   "afk",			COMM_AFK,		FALSE	},
    {   "nocommands",           COMM_NOCOMMANDS,        TRUE   },
    {	NULL,			0,			0	}
};


/* Mobile Program Flags */
...
const struct flag_type room_flags[] =
{
    ...
    {   "home_room",            ROOM_HOME,              TRUE    },
    {	"bank",			ROOM_BANK,		TRUE	},
    {   "no_gate",              ROOM_NOGATE,              TRUE    },
    {   "no_teleport",          ROOM_NOTPORT,              TRUE    },
    {   "sleep",                ROOM_SLEEP,            TRUE      },
    {   "rquest",               ROOM_QUEST,            TRUE      },
    {	NULL,			0,			0	}
};
...
/******************************************************************
 *Added 2003 Room Affect Flags.
 *Can now have room upon entering, teleport or cast spells on 
 *Players.  --Kizeren
 ******************************************************************/
...
const struct flag_type can_eat_flags[]=
{
    {  "quest_point",     QUEST_POINT,          TRUE    },
    {  "train_point",     TRAIN_POINT,          TRUE    },
    {  "practice_point",  PRACTICE_POINT,       TRUE    },
    {  NULL,              0,                    0       }
};
...
struct	hometown_type	hometown_table [MAX_HOMETOWN] =
{

};

const struct city_titles city_rank_table[] =
{   
    {
         "Newbie", 0
    },
