...
DECLARE_DO_FUN( do_whocity);
DECLARE_DO_FUN( do_ntell);
DECLARE_DO_FUN( do_ctell);
DECLARE_DO_FUN( do_mtell);
DECLARE_DO_FUN(do_ctell);
DECLARE_DO_FUN(do_grant);
DECLARE_DO_FUN(do_mlead);
...
DECLARE_DO_FUN(do_inside);
DECLARE_DO_FUN(do_outside);
