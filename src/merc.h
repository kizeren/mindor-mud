...
#define OBJ_VNUM_ORANGE		 19
#define OBJ_VNUM_APPLE		 24
#define OBJ_VNUM_BANANNA         29
...
#define TITLE_DIR       "../data/titles/"  /*Titles of classes */
