...
void do_scan(CHAR_DATA *ch, char *argument)
{
   ...
   else if (!str_cmp(arg1, "ne") || !str_cmp(arg1, "northeast"))  door = 
6;
   else if (!str_cmp(arg1, "se") || !str_cmp(arg1, "southeast"))  door = 
7;
   else if (!str_cmp(arg1, "sw") || !str_cmp(arg1, "ssouthwest"))  door = 
8;
   else if (!str_cmp(arg1, "nw") || !str_cmp(arg1, "northwest"))  door = 
9;
