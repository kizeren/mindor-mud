...
/*  {   command		function	}, */
    ...
    {   "iinside",              redit_inside    },
    {   "outside",              redit_outside   },
    /* New reset commands. */
    {	"mreset",	redit_mreset	},
    {	"oreset",	redit_oreset	},
    {	"mlist",	redit_mlist	},
...
void do_aedit( CHAR_DATA *ch, char *argument )
{
	...
	if ( !str_cmp( arg, "create" ) )
	{
	    ...
	    if (get_area_data(value) != NULL)
	       {
	        	send_to_char("Area already exits!",ch);
	        	return;
	       }
	    pArea               =   new_area();
...
void do_redit( CHAR_DATA *ch, char *argument )
{
    ...
    else
    {
	    ...
	    if (atoi(arg1) != 0)
	    {
	       send_to_char("Insufficient security to create room, or room exists.\n\r",ch);
	       return;
	    }   
    }
...
void do_oedit( CHAR_DATA *ch, char *argument )
{
	...
	if ( !str_cmp( arg1, "create" ) )
	{
	    ...
	    if ( !IS_BUILDER( ch, pArea ) )
	    {
		send_to_char( "Insufficient security to create object.\n\r" , ch );
	        return;
	    }
...
void do_alist( CHAR_DATA *ch, char *argument )
{
    ...
    output = new_buf();
    x = 20000000;  /* If you have vnums higher than this, make this number bigger */
    y = 0;
